...
import TestimoniesMobile1 from '../public/images/Projects/testimonies-mobile/5.png';
...
const FeaturedProjectsData: FeaturedProject[] = [
  {
    ...
    description:
      'An enterprise-grade corporate internet banking platform developed for FCMB Group, enabling businesses to manage accounts, initiate payments, oversee beneficiaries, authorize transactions, and monitor financial activities through a secure digital banking environment.',
    image: cibWeb1,
    screenshots: [cibWeb1],
    coreTools: [
      'Next.js',
  ...
  },
  {
    ...
    description:
      'Fintech application built for Sterling Bank that enables users to manage multi-currency accounts, perform local and international money transfers, pay bills, access investment and insurance services, and manage their finances from a single platform.',
    image: switchImg,
  ...
  },
  {
    ...
    screenshots: [TestimoniesWebClient1],
    coreTools: [
      'Next.js',
      'React',
  ...
  },
  {
    ...
    description:
      'A secure React Native mobile banking application built for FCMB Group that enables corporate customers to manage business accounts, initiate and authorize transactions, oversee beneficiaries, and perform day-to-day banking operations from anywhere.',
    image: cibApp1,
    screenshots: [cibApp1],
    coreTools: [
      'React Native',
  ...
  },
  {
    ...
    screenshots: [TestimoniesMobile1],
    coreTools: [
      'React Native',
      'NativeWind',
      'Redux Toolkit',
  ...
  },
  {
    ...
    description:
      'Web-based administrative platform built for Alerzo and designed to manage B2B commerce operations, merchant onboarding, order fulfillment, inventory monitoring, logistics coordination, and business performance reporting.',
    image: alerzo1,
    screenshots: [alerzo1],
  ...
  },
  {
    ...
    description:
      'A customer-facing hospitality platform developed for Lexis Kitchen to showcase menu offerings, streamline reservation requests, and facilitate customer engagement through digital inquiry workflows.',
    image: lexisKitchen1,
  ...
  },
  {
    ...
    description:
      'A comprehensive edtech platform designed to help secondary school students master mathematics through personalized learning experiences, interactive exercises, progress tracking, and curriculum-aligned educational content.',
    image: a1Quest1,
  ...
  },
  {
    ...
    description:
      'A comprehensive business operations platform designed for merchants to manage transactions, monitor business performance, process payments, and gain real-time operational insights.',
    image: veedez1,
    screenshots: [veedez1],
    coreTools: [
      'Redux Toolkit',
  ...
  },
  {
    ...
    description:
      "A centralized enterprise platform developed for CAP Plc's ConnectUs ecosystem, providing partners and administrators with real-time operational visibility, order management capabilities, business analytics, and performance monitoring tools.",
    image: zeebly1,
    screenshots: [zeebly1],
    coreTools: [
      'Zod',
  ...
  },
  {
    ...
    description:
      "A modern church website built for The Father's House Church with Next.js and Redux Toolkit to support digital ministry, community engagement, event communication, and outreach initiatives.",
    image: tfhWeb1,
    screenshots: [tfhWeb1],
    coreTools: [
      'Next.js',
  ...
  },
  {
    ...
    description:
      'A React Native mobile application designed to strengthen church engagement by providing members and visitors with convenient access to church resources, ministry content, events, announcements, and community interactions.',
    image: tfhMobile1,
  ...
  },
  {
    ...
    description:
      'A customer-facing web application developed for Koneqtor to streamline onboarding, service requests, account management, and customer support interactions.',
    image: koneqtorWeb1,
  ...
  },
  {
    ...
    description:
      'A modern digital marketing platform built for Keyla to showcase services, communicate brand value, and drive customer acquisition through engaging content and lead generation workflows.',
    image: keylaWeb1,
