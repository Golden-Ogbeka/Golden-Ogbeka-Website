...
const Projects: ProjectType[] = [
  {
    ...
    slug: 'rova-cba-cib-client-frontend',
        description: "A corporate banking client portal for FCMB Group with secure login, account and beneficiary management, single and bulk payments, approval workflows, transaction reporting, and web-security controls.",
    features: [
  ...
  {
    title: "Alerzo Logistics Admin Dashboard",
    slug: 'alerzo-admin-web',
        description: "A logistics operations admin portal for Alerzo that manages orders, customers, drivers, shipments, settlement analytics, and GraphQL-based operational controls.",
    features: [
  ...
  },
  {
    ...
    slug: 'veedezwebsite',
        description: "A marketing website for Veedez with animated service showcase, pricing and product positioning, lead capture forms, and responsive Chakra UI sections.",
    features: [
  ...
  },
  {
    ...
    slug: 'veedez-web-app',
        description: "A merchant operations web portal for Veedez with business transaction dashboards, payment checkout, analytics, and Firebase-backed access control.",
    features: [
  ...
  },
  {
    ...
    slug: 'zeebly-admin',
        description: "A CAP Plc analytics dashboard built with Apollo and Material UI, focused on KPI reporting, admin workflows, and GraphQL-powered operational insights.",
    features: [
  ...
  },
  {
    ...
    slug: 'clicknchedule-api',
        description: "A shift scheduling backend API for Click N Schedule that handles roster creation, shift assignment, notifications, and secure authentication.",
    features: [
  ...
  {
    title: "Mono Web Crowdfunding Portal",
    slug: 'mono-web',
        description: "A corporate crowdfunding portal built with React and Material UI to showcase investment opportunities, campaign details, and investor onboarding content.",
    features: [
  ...
  },
  {
    ...
    slug: 'frsc-website',
        description: "A public-facing website for FRSC Lagos with road safety campaigns, service announcements, contact information, and public awareness content.",
    features: [
  ...
  },
  {
    ...
    slug: 'afripie-frontend',
        description: "A bill payment gateway frontend for Afripie with customer onboarding, service selection, checkout flows, and authenticated transaction processing.",
    features: [
  ...
  },
  {
    ...
    slug: 'truevoix-website',
        description: "A campaign website for Truevoix featuring government engagement, stakeholder communication, and responsive content sections.",
    features: [
  ...
  },
  {
    ...
    slug: 'lexis-kitchen',
        description: "A service inquiry portal for Lexis Kitchen with menu browsing, reservation request forms, and email-based booking workflows.",
    features: [
  ...
  },
  {
    ...
    slug: 'rova-cba-cib-ng-app-lite',
        description: "A lightweight React Native mobile banking app for corporate users, providing secure account access, transfers, beneficiary management, and mobile workflow navigation.",
    features: [
  ...
  },
  {
    ...
    slug: 'tennis-slide-api',
        description: "A backend service for Tennis Slide that powers booking, schedule management, match notifications, and player session handling.",
    features: [
  ...
  },
  {
    ...
    slug: 'a1quest-admin-web',
        description: "An enterprise admin dashboard for A1Quest with reporting panels, user management, and internal operational workflows.",
    features: [
  ...
  },
  {
    ...
    slug: 'a1quest-web',
        description: "A customer-facing portal for A1Quest with marketing sections, service details, onboarding, and secure Firebase-backed logins.",
    features: [
  ...
  },
  {
    ...
    slug: 'cravings-admin-frontend',
        description: "A restaurant admin dashboard for Cravings with order management, reporting, and operations controls built on Material UI.",
    features: [
  ...
  },
  {
    ...
    slug: 'cravings-web-frontend',
        description: "A customer web frontend for Cravings with menu browsing, booking flows, and order status tracking.",
    features: [
  ...
  },
  {
    ...
    slug: 'cravings-logistics-client-side',
        description: "A logistics client portal for Cravings that manages driver bookings, route planning, delivery schedules, and customer dispatch screens.",
    features: [
  ...
  },
  {
    ...
    slug: 'keyla-site-Frontend',
        description: "A Gatsby marketing site for Keyla with static page generation, styled-components theming, and lead contact forms.",
    features: [
  ...
  },
  {
    ...
    slug: 'koneqtor-admin-frontend',
        description: "A business admin panel for Koneqtor with analytics dashboards, account actions, and internal service workflows.",
    features: [
  ...
  },
  {
    ...
    slug: 'koneqtor-frontend',
        description: "A client-facing Koneqtor portal with onboarding, service ordering, and support workflows backed by Redux state management.",
    features: [
  ...
  },
  {
    ...
    slug: 'landshop-adminpanel',
        description: "A real estate admin panel for Landshop with inventory controls, listing management, and customer relationships.",
    features: [
  ...
  },
  {
    ...
    slug: 'ship-africa-admin-web',
        description: "A logistics admin portal for Ship Africa with shipment management, carrier tracking, and operational dashboards.",
    features: [
  ...
  },
  {
    ...
    slug: 'ship-africa-web',
        description: "A customer logistics app for Ship Africa with booking, shipment tracking, and service request workflows.",
    features: [
  ...
  },
  {
    ...
    slug: 'shipmust-web',
        description: "A service landing website for Shipmust with product descriptions, testimonials, and responsive business content.",
    features: [
  ...
  },
  {
    ...
    slug: 'shipplug',
        description: "A Vue client portal for Shipplug with service workflows, responsive form handling, and real-time status updates.",
    features: [
  ...
  },
  {
    ...
    slug: 'transaction-viewer',
        description: "A full-stack transaction viewing application with client-server integration for data inspection, filtering, and secure event tracking.",
    features: [
  ...
  },
  {
    ...
    slug: 'value-female-network',
        description: "A financial services platform for Value Female Network that supports savings, transfers, user onboarding, and secure transaction history.",
    features: [
  ...
  },
  {
    ...
    slug: 'authentication-api',
        description: "An Express authentication API with JWT login, password hashing, user registration, and MongoDB persistence.",
    features: [
  ...
  },
  {
    ...
    slug: 'autocomplete-component',
        description: "A React autocomplete component demo with intelligent filtering, keyboard navigation, and test coverage for UX reliability.",
    features: [
  ...
  },
  {
    ...
    slug: 'boldo-design-implementation',
        description: "A responsive landing page implementation of the Boldo design system using Next.js for fast marketing page delivery.",
    features: [
  ...
  },
  {
    ...
    slug: 'ceejayne',
        description: "A full-stack business platform with Express backend APIs, React client workflows, authentication, and file upload handling.",
    features: [
  ...
  },
  {
    ...
    slug: 'e-bike',
        description: "A product showcase app for an e-bike brand with feature-driven product pages, responsive user interface, and shopping appeal.",
    features: [
  ...
  },
  {
    ...
    slug: 'find-it',
        description: "A location search backend for Find It with geocoding, search endpoints, and Google Maps integration.",
    features: [
  ...
  },
  {
    ...
    slug: 'glow-stopper',
        description: "A security-focused backend service for Glow Stopper with authentication, email workflows, file uploading, and MySQL persistence.",
    features: [
  ...
  },
  {
    ...
    slug: 'library-app',
        description: "A library management web app with book browsing, borrowing workflows, reservation history, and inventory state management.",
    features: [
  ...
  },
  {
    ...
    slug: 'mini-todo-app-server',
        description: "A PostgreSQL-backed todo API server exposing CRUD endpoints, validation, and secure task management workflows.",
    features: [
  ...
  {
    title: "OTK Contact Manager",
    slug: 'otk-contact-manager',
        description: "A contact management interface with add/edit/delete workflows, validated forms, and search-friendly contact lists.",
    features: [
      "Contact add/edit/delete form workflows",
      "Validated input fields with Formik and Yup",
      "Responsive contact listing and search interface",
      "Bootstrap-based styling and UI layout",
      "React Router flows for navigation between contacts",
    ],
    coreTools: [
      "React",
      "Formik",
  ...
  },
  {
    ...
    slug: 'product-catalog-with-unsplash-api',
        description: "A product catalog service with Unsplash image sourcing, product search, and backend API integration.",
    features: [
  ...
  },
  {
    ...
    slug: 'risevest-homepage-build',
        description: "A responsive marketing homepage for Risevest with feature storytelling, user testimonials, and product call-to-action design.",
    features: [
  ...
  },
  {
    ...
    slug: 'saas-landing-page-vue',
        description: "A Vue SaaS landing page with product features, responsive service sections, and marketing-focused calls to action.",
    features: [
  ...
  },
  {
    ...
    slug: 'secure-shift-api',
        description: "A secure shift management API with rate limiting, input sanitization, and protected Express endpoints for workforce scheduling.",
    features: [
  ...
  },
  {
    ...
    slug: 'simple-cart',
        description: "A shopping cart demo app with product selection, cart state updates, and checkout-ready UI flows.",
    features: [
  ...
  },
  {
    ...
    slug: 'ocpus-client',
        description: "A mobile client for Ocpus with Apollo GraphQL data fetching, map-based workflows, and native navigation flows.",
    features: [
  ...
  },
  {
    ...
    slug: 'zwilt-client',
        description: "A multiplatform Zwilt client with Apollo GraphQL, Material UI, and web/mobile service dashboards.",
    features: [
  ...
  },
  {
    ...
    slug: 'switch3.0',
        description: "A React Native fintech app for Switch 3.0 with native device APIs, analytics, secure auth, and banking workflows.",
    features: [
  ...
  },
  {
    ...
    slug: 'tcu-mobile',
        description: "A React Native app for TCU with native media access, navigation drawers, offline sync, and financial transaction views.",
    features: [
  ...
  },
  {
    ...
    slug: 'thechickenuniverse',
        description: "A full-stack hospitality platform for TheChickenUniverse with Express backend APIs, EJS frontend pages, and order/content workflows.",
    features: [
  ...
  },
  {
    ...
    slug: 'account-connect-app',
        description: "A full-stack account connection app with React client and Express backend for account linking and user onboarding.",
    features: [
  ...
  },
  {
    ...
    slug: 'tfh-admin-frontend',
        description: "A TFH admin dashboard with responsive management screens, form workflows, draft-rich content editing, and order handling.",
    features: [
  ...
  },
  {
    ...
    slug: 'tfh-backend',
        description: "A TFH backend API with Cloudinary media handling, authentication, and secure Express validation routes.",
    features: [
  ...
  },
  {
    ...
    slug: 'tfh-website',
        description: "A TFH marketing website built with Next.js and Redux Toolkit for brand storytelling, service pages, and customer discovery.",
    features: [
  ...
  },
  {
    ...
    slug: 'tfhmobile',
        description: "A TFH mobile app with native navigation, form-driven account workflows, and mobile-first service interactions.",
    features: [
