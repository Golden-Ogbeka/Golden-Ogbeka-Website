	...
	return (
		<div className='mt-[117px]'>
			...
			<p className='text-lg font-extralight dark:text-[#F0F0F0] mb-10'>
				I&apos;m a frontend web developer based in Lagos, Nigeria. I&apos;m passionate about
				using technology to create solutions for people and have experience doing so in these
				sectors: Agriculture, Finance, Real Estate, Sales, IT, Food and Logistics.
			</p>
			<div className='flex flex-row gap-5 items-center flex-wrap'>
				...
				<a href='https://www.linkedin.com/in/goldenogbeka/' target='_blank' rel='noreferrer'>
